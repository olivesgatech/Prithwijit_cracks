...
for MODEL in "${MODELS[@]}"; do
    for CATEGORY in "${CATEGORIES[@]}"; do
        INPUT_PATH="/mnt/HD_18T_pt1/prithwijit/models_predictions/${MODEL}/thebe/${CATEGORY}/logits/"
        OUTPUT_PATH="/mnt/HD_18T_pt1/prithwijit/models_predictions/${MODEL}/thebe/${CATEGORY}/logits_stitched/"
