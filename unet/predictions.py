...
from utils import SeismicNumpyDataset, SeismicSegmentationDataset
...
def main(args):
    ...
    test_dataset = SeismicNumpyDataset(args.test_image_folder, args.test_label_folder, image_transform, mask_transform)
    ...
    with torch.no_grad():
        ...
        for images, masks, filenames in test_loader_tqdm:
            ...
            save_outputs = F.interpolate(outputs, size=(254, 254), mode="bilinear", align_corners=False)
